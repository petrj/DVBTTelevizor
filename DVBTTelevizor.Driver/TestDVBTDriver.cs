...
namespace DVBTTelevizor
{
    public class TestDVBTDriver
    {
        ...
        public string PublicDirectory { get; set; } = String.Empty;
        ...
        public void Connect()
        {
            ...
            var controlPort = UDPStreamer.FindAvailablePort(32000, 33000);
            var transferPort = UDPStreamer.FindAvailablePort(42000, 43000);
        ...
        private byte[] GetCapabilities()
        {
            ...
            {
                bytesToSend.AddRange(DVBTDriverStatus.GetByteArrayFromBigEndianLong(payloadItem));
            }
        ...
        private byte[] Tune(byte[] request)
        {
            ...
            bytesToSend.AddRange(DVBTDriverStatus.GetByteArrayFromBigEndianLong(1)); // success flag
        ...
        private byte[] SetPIDs(byte[] request)
        {
            ...
            lock (key)
            {
                ...
                {
                    var pid = DVBTDriverResponse.GetBigEndianLongFromByteArray(request, 2 + i * 8);
                    _PIDFilter.Add(pid);
                }
